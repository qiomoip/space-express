...
const LPDIRECT3DVERTEXBUFFER9	CTerrainMesh::GetVtxInfo() const 
{
	return m_pVB;
}

const LPDIRECT3DINDEXBUFFER9	CTerrainMesh::GetIdxInfo() const 
{
	return m_pIB;
}

const TERRAININFO CTerrainMesh::GetTerrainInfo() const
{
	return m_tInfo;
}